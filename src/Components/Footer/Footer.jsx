    ...
    <footer className="footer">
      <div className="container footer__container">
        <div className="footer-top">
          <a className="footer-top__link" href="#link">
            <img src={FooterLogoImg} alt="" width="202" height="27" />
          </a>
          <hr className="hr-1" />
        ...
        <div className="footer-bottom">
          <ul className="footer-bottom__list">
            <li className="footer-bottom__item">Designo Central Office</li>
            <li className="footer-bottom__item">3886 Wellington Street</li>
            <li className="footer-bottom__item">Toronto, Ontario M9C 3J5</li>
          </ul>
          <ul className="footer-bottom__list">
            <li className="footer-bottom__item">Contact Us (Central Office)</li>
            <li className="footer-bottom__item">
              P :
              <a className="footer-bottom__link" href="tel:+1253-863-8967">
                +1 253-863-8967
              </a>
            </li>
            <li className="footer-bottom__item">
          ...
          <div className="footer-bottom__subscribe">
            <a href="http://facebook.com/">
              <svg
                className="footer-bottom__subscribe--link"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
